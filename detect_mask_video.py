...
# load face mask detector model (trained model)
print("[INFO] loading trained face mask detector model...")
...
while True:
	# read and resize frame ( max width = 400 )
	frame = vs.read()
	frame = imutils.resize(frame, width=400)

	# detect faces and predict mask usage ( wearing or not wearing )
	...
	for (box, pred) in zip(locations, predictions):
		...
		# determine class label and color use for result
